...
Компьютеры общие: личная папка, сохранение и проверенная копия. На первом блоке — без обязательного Git/аккаунта; GitHub необязателен весь семестр. Подробно — в [ПЕРВЫЙ_СТАРТ.md](docs/ПЕРВЫЙ_СТАРТ.md).
...
Готовы тетради 02.1 и 02.2; условия первой лабораторной — [ЛР1](docs/ЛР1.md). Новые файлы добавляйте по [инструкции обновления](docs/ПЕРВЫЙ_СТАРТ.md), сохраняя старые ответы.
